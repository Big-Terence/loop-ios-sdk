...
public enum LoopValue: Encodable, Equatable, Sendable {
    case string(String)
    case int(Int)
    case double(Double)
    case bool(Bool)
...
extension LoopValue: ExpressibleByStringLiteral, ExpressibleByIntegerLiteral,
...
public struct EventContext: Encodable, Sendable {
    ...
    public init(
        sdk: String = "loop-ios",
        sdkVersion: String? = LoopSDKInfo.version,
        os: String? = nil,
...
public struct EventEnvelope: Encodable, Sendable {
    ...
    public var properties: [String: LoopValue]
